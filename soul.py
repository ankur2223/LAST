...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*KOI DIKAAT HAI TOH ADMIN KO MESSEGE KRLE BHAI JADA GYAN CHODU BANNE KI JARURT NHI HAI SMJA LAODE*",  parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.send_message(message.chat.id, "* Admin @L_X_OP JOIN CHANNEL ELSE NOT WORK : https://t.me/+XEaNesda8_41MGY9*", parse_mode='Markdown')
    else:
